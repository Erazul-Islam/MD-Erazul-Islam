    ...
    <section >
      ...
      <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
        <div className="lg:flex lg:mt-12 justify-between">
          <img alt="Taosif" className="w-52 lg:ml-[310px] m-auto h-52 border border-pink-700 rounded-full " src="https://res.cloudinary.com/djs5y6ey5/image/upload/v1735572158/web-photoaidcom-cropped_fhjkb6.png" />
