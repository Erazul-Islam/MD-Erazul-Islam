...
const SkillsCardDatabase: React.FC<SkillsCardProps> = ({ skills }) => {
  return (
    <div className=" rounded-xl max-w-xs  shadow-lg hover:shadow-2xl">
      <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">
        Database
      </h2>
      <div className="space-y-3">
        {skills.backend?.map((one, i) => (
          <div
            key={i}
...
export default SkillsCardDatabase;
